...
#define USER_INFO_ADD 	0x08007C00
...
typedef enum {
	...
	OUTPUT_RS232=USER_INFO_RS232_OUTP
} TIPO_OUTPUT;

typedef enum {
	WIEGAND_26=USER_INFO_WIEGAND26,
	WIEGAND_32=USER_INFO_WIEGAND32,
...
extern TIPO_LEITOR tipo_leitor;
